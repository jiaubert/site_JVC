 ...
 */
final class Version20210707125525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD forum_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE post ADD post_categories_id INT NOT NULL');
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8DBD63AAA4 FOREIGN KEY (post_categories_id) REFERENCES post_category (id)');
        $this->addSql('CREATE INDEX IDX_5A8A6C8DBD63AAA4 ON post (post_categories_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post DROP FOREIGN KEY FK_5A8A6C8DBD63AAA4');
        $this->addSql('DROP INDEX IDX_5A8A6C8DBD63AAA4 ON post');
        $this->addSql('ALTER TABLE post DROP post_categories_id');
